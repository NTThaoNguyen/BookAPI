...
import com.example.book.security.jwt.JwtAuthEntryPoint;
import com.example.book.security.jwt.JwtAuthTokenFilter;
...
//                .antMatchers(HttpMethod.GET,"/api/user/**").hasAnyRole("ADMIN","USER")
                .antMatchers(HttpMethod.GET, "/api/categories/**", "/api/products/**", "/api/product-categories/**","/api/authors/**","/api/NXBs/**").permitAll()
//                .antMatchers("/api/users", "/api/categories", "/api/products","/api/authors","/api/NXBs").hasRole("ADMIN")
